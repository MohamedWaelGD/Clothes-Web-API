    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClothItems_Cloths_ClothId",
                        column: x => x.ClothId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.UserId, x.ClothId });
                    table.ForeignKey(
                        name: "FK_Reviews_Cloths_ClothId",
                        column: x => x.ClothId,
                        principalTable: "Cloths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserNumberId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_UserNumbers_UserNumberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClothItemId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClothImages_ClothItems_ClothItemId",
                        column: x => x.ClothItemId,
                        principalTable: "ClothItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.ClothItemId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_OrderItems_ClothItems_ClothItemId",
                        column: x => x.ClothItemId,
                        principalTable: "ClothItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothImages_ClothItemId",
                table: "ClothImages",
                column: "ClothItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ClothItems_ClothId",
                table: "ClothItems",
                column: "ClothId");
